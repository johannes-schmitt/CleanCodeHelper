...
{
    [ExpectedDiagnostic("CC0007", Arguments = new object[] { nameof(SomeMethod4) }, Line = 10, Column = 21)]
    [ExpectedDiagnostic("CC0007", Arguments = new object[] { nameof(SomeMethod5) }, Line = 18, Column = 21)]
